...
mmcboot=run load_fit_tftp; run set_bootargs_nfs; run boot_fit
" > optee/build/rpi3/firmware/uboot.env.txt

# bootargs=smsc95xx.macaddr= dma.dmachans=0x7f35 rootwait 8250.nr_uarts=1 fsck.repair=yes bcm2708_fb.fbwidth=1920 bcm2708_fb.fbheight=1080 vc_mem.mem_base=0x3ec00000 vc_mem.mem_size=0x40000000 dwc_otg.fiq_enable=0 dwc_otg.fiq_fsm_enable=0 dwc_otg.nak_holdoff=0 root=/dev/nfs rw rootfs=nfs nfsroot=192.168.1.1:/srv/nfs/rootfs,tcp,nfsvers=4 ip=dhcp nfsrootdebug
